  ...
  def preprocess_h5_file(self, mode, filename, max_length):
    ...
    for sentence in sentences_txt:
      ...
      for i in range(len(words)):
        ...
        if words[i] not in list(self.vocab.keys()):
          if mode == 'train':
...
# x.preprocess_h5()
# x = PreprocessH5('../preprocess/yafc_formal.train.txt', '../preprocess/yafc_formal.test.txt', '../preprocess/yafc_formal.valid.txt', 'shakespeare_modern.h5', 'yafc_formal.json', 20)
# x.preprocess_h5()
